...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #Creating an instance to store game stsats
    ...
    def _ship_hit(self):
        """Respond to the ship being hit by the alien ship"""
        if self.stats.ships_left >0:

            self.stats.ships_left -=1 #Decreament no of ships

            #Rid of any bullets and aliens
            self.bullets.empty()
            self.aliens.empty()
